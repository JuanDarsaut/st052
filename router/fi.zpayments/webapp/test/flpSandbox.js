		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Payments",
									"targetURL": "#comtelefonicafiorifizpayments-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtelefonicafiorifizpayments-display": {
								"semanticObject": "comtelefonicafiorifizpayments",
								"action": "display",
								"description": "Provision/Loan/Deferred payment reporting tables",
								"title": "Payments",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.telefonica.fiori.fi.zpayments",
									"url": sap.ui.require.toUrl("com/telefonica/fiori/fi/zpayments")
								}
							}
						}
					}
